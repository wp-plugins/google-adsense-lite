...
<footer class="row">
  ...
  <p class="col-md-4 col-sm-4 col-xs-12"><a href='http://www.thulasidas.com/packages/ezpaypal' class='popup'><img class="col-md-4 col-sm-4 center" src="img/paypal-partner.png" alt="Official PayPal Partner" title="This developer is an official PayPal partner" data-toggle="tooltip"/></a></p>
