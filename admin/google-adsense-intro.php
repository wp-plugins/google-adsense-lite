...
<p>
<a class="btn btn-primary btn-help" data-content="<p>Ads EZ Plugin for Google AdSense provides a streamlined interface to deploy Google ads on your blog. You can customize the colors and sizes of the ad blocks and activate them right from the plugin interface.</p><ol>
...
<a class="btn btn-primary btn-help" data-content="<p>In addition to the fully functional Lite version, there is a <a href='http://buy.thulasidas.com/google-adsense' title='Get Google AdSense Ultra for $9.45' class='goPro' data-product='google-adsense'>Pro Version</a> with many more features.</p>
    ...
    </ol><p><em><strong>Ads EZ Plugin for Google AdSense Ultra</strong></em> is the evolution of three wildly popular AdSense plugins: <strong>Easy AdSense</strong>, <strong>AdSense Now!</strong> and <strong>Google AdSense</strong>. It combines the features of all three of these plugins, and can operate as any one of them. For instance, if you choose the Easy AdSense mode, a menu item with the title Easy AdSense will appear which will take you to the familiar interface of that plugin.</p>"><i class='glyphicon glyphicon-plane'></i> Pro Features</a>

<a href='google-adsense-admin.php' class="btn btn-primary btn-info" data-content="<p>Enter the configuration tab. You can also click on the <strongGoogle AdSense</strong> tab above.</p>"><i class='glyphicon glyphicon-cog'></i> Setup</a>
